...
public class Current {
	...
	public Current(int last_updated_epoch, String last_updated, double temp_c, double temp_f, int is_day,
			...
			int dewpoint_c, double dewpoint_f, int vis_km, int vis_miles, double uv, double gust_mph, double gust_kph,
			AirQuality air_quality, double short_rad, double diff_rad, double dni, double gti) {
		super();
